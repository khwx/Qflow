      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 text-center border border-gray-200 dark:border-gray-700 animate-scale-in">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <button
            ...
            className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
            Voltar ao início
          </button>
        </div>
