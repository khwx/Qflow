...
export default function TVDisplayPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'serving': return 'bg-yellow-100 text-yellow-800'
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 to-purple-900 flex items-center justify-center">
        <div className="text-center">
          <p className="text-white text-2xl">Estabelecimento não encontrado</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 to-purple-900 text-white">
      <header className="p-8 flex justify-between items-start">
        <div>
          ...
          <p className="text-white/80 text-xl">Painel de Senhas</p>
        </div>
        <button
                ...
                <div key={queue.id} className="bg-white/10 backdrop-blur rounded-2xl p-6">
                  ...
                  {called.length > 0 && (
                    <div className="bg-green-500/20 border-2 border-green-400 rounded-xl p-6 mb-6 animate-pulse">
                      <p className="text-green-300 text-lg mb-2">🚨 COMPAREÇA</p>
                      {called.map(t => (
                  ...
                  {serving.length > 0 && (
                    <div className="bg-yellow-500/20 border-2 border-yellow-400 rounded-xl p-4 mb-6">
                      <p className="text-yellow-300 text-lg mb-2">Em atendimento</p>
                      {serving.map(t => (
                  ...
                  <div className="bg-white/5 rounded-xl p-4">
                    <p className="text-white/80 mb-3">Próximas senhas</p>
